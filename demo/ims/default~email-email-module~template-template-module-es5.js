...
var TemplateComponent = /** @class */ (function () {
    function TemplateComponent(templateservice, router, fb) {
        this.templateservice = templateservice;
        this.router = router;
    ...
    //   $event.focus();
    // }
    TemplateComponent.prototype.patchValue = function () {
        this.form.controls["editor"].patchValue(this.form.controls["editor"].value + " patched!");
    };
    TemplateComponent.prototype.toggleReadOnly = function () {
...
//# sourceMappingURL=default~email-email-module~template-template-module-es5.js.map