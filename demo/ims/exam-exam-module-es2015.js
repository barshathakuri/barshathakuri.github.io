...
let AddExamComponent = class AddExamComponent {
    constructor(examervice, router, activeRouter) {
    ...
    submit() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                this.examervice.addExam(this.newexam).subscribe((data) => {
...
let EditExamComponent = class EditExamComponent {
    constructor(examervice, router, activeRouter) {
        this.examervice = examervice;
        this.router = router;
        this.activeRouter = activeRouter;
    ...
    ngOnInit() {
        this.examervice.getExamById(this.examid).subscribe((data) => {
            console.log("examlist>>", data);
            this.updatedExam = data.data;
        }, error => {
    ...
    update() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                this.examervice.editExam(this.updatedExam).subscribe((data) => {
...
EditExamComponent.ctorParameters = () => [
    { type: _services_exam_services__WEBPACK_IMPORTED_MODULE_2__["ExamService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
...
let ExamRoutingModule = class ExamRoutingModule {
};
...
let ExamService = class ExamService extends _shared_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super("exam");
        this.http = http;
    }
