...
var AddEnquiriesComponent = /** @class */ (function () {
    function AddEnquiriesComponent(enquiriessservice, router) {
    ...
    AddEnquiriesComponent.prototype.ngOnInit = function () { };
    AddEnquiriesComponent.prototype.submit = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a
            ...
            if (result.value) {
                //dev
                _this.enquiriessservice.addEnquiries(_this.newenquiries).subscribe(function (data) {
    ...
    AddEnquiriesComponent.ctorParameters = function () { return [
...
var EditEnquiriesComponent = /** @class */ (function () {
    function EditEnquiriesComponent(enquiriesservice, router, activeRouter) {
    ...
    EditEnquiriesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.enquiriesservice.getEnquiriesById(this.enquiriesid).subscribe(function (data) {
            console.log("data", data);
            _this.updatedEnquiries = data;
        }, function (error) {
            console.log("error-->", error);
        });
    };
    EditEnquiriesComponent.prototype.edit = function () {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            .then(function (result) {
            if (result.value) {
                _this.enquiriesservice
                    .editEnquiries(_this.updatedEnquiries, _this.enquiriesid)
                    .subscribe(function (data) {
                    console.log("enquiries added successfully");
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
                        .fire("Updated!", "Enquiries Updated.", "success")
                        .then(function () {
                        _this.router.navigate(["enquiries"]);
                    });
                    _this.ngOnInit();
                }, function (error) {
    ...
    EditEnquiriesComponent.ctorParameters = function () { return [
        { type: _services_enquiries_service__WEBPACK_IMPORTED_MODULE_2__["EnquiriesService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var EnquiriesComponent = /** @class */ (function () {
    function EnquiriesComponent(enquiriesservice, router) {
        this.enquiriesservice = enquiriesservice;
        this.router = router;
        this.enquiriesList = [];
    }
    EnquiriesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.enquiriesservice.getEnquiries().subscribe(function (data) {
            _this.enquiriesList = data;
            console.log(data);
        }, function (error) {
            console.log(error);
        });
    };
    EnquiriesComponent.prototype.delete = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            .fire({
            ...
            .then(function (result) {
            if (result.value) {
                _this.enquiriesservice.deleteEnquiries(id).subscribe(function (data) {
    ...
    EnquiriesComponent.ctorParameters = function () { return [
...
var EnquiriesService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](EnquiriesService, _super);
    function EnquiriesService(http) {
        var _this = _super.call(this, "enquiries") || this;
        _this.http = http;
        return _this;
    }
    EnquiriesService.prototype.getEnquiries = function () {
        return this.http.get(this.url);
    };
    EnquiriesService.prototype.addEnquiries = function (data) {
        return this.http.post(this.url + "add/", data, this.getOptions());
    };
    EnquiriesService.prototype.getEnquiriesById = function (id) {
        return this.http.get(this.url + "edit/" + id, this.getOptions());
    };
    EnquiriesService.prototype.editEnquiries = function (updatedData, id) {
        return this.http.put(this.url + "edit/" + id, updatedData, this.getOptions());
    };
    EnquiriesService.prototype.deleteEnquiries = function (id) {
        return this.http.delete(this.url + "delete/" + id, this.getOptions());
    };
    EnquiriesService.ctorParameters = function () { return [
...
var Enquiries = /** @class */ (function () {
    function Enquiries(enquiriesInfo) {
    ...
    Enquiries.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return Enquiries;
}());
...
//# sourceMappingURL=enquiries-enquiries-module-es5.js.map