...
let AddManagementComponent = class AddManagementComponent {
    constructor(managementservice, router, activeRouter) {
    ...
    submit() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                this.managementservice.addManagement(this.newmanagement).subscribe((data) => {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
...
AddManagementComponent.ctorParameters = () => [
...
let EditManagementComponent = class EditManagementComponent {
    constructor(managementservice, router, activeRouter) {
        this.managementservice = managementservice;
        this.router = router;
        this.activeRouter = activeRouter;
...
EditManagementComponent.ctorParameters = () => [
    { type: _services_management_service__WEBPACK_IMPORTED_MODULE_2__["ManagementService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
...
let ManagementComponent = class ManagementComponent {
    constructor(managementservice, router) {
        this.managementservice = managementservice;
        this.router = router;
        this.managementList = [];
    }
    ...
    delete(id) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                this.managementservice.deleteManagement(id).subscribe((data) => {
...
let ManagementService = class ManagementService extends _shared_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super("management");
        this.http = http;
    }
...
ManagementService.ctorParameters = () => [
...
//# sourceMappingURL=management-management-module-es2015.js.map