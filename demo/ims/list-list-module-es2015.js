...
let AddListComponent = class AddListComponent {
    constructor(listsservice, router) {
    ...
    submit() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a
            ...
            if (result.value) {
                //dev
                this.listsservice.addList(this.newlist).subscribe((data) => {
...
AddListComponent.ctorParameters = () => [
...
let EditListComponent = class EditListComponent {
    constructor(listservice, router, activeRouter) {
    ...
    edit() {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            .then(result => {
            if (result.value) {
                this.listservice.editList(this.updatedList, this.listid).subscribe((data) => {
                    console.log("list added successfully");
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire("Updated!", "List Updated.", "success").then(() => {
...
let ListService = class ListService extends _shared_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(http) {
        super("list");
        this.http = http;
    }
