...
var AddSectionComponent = /** @class */ (function () {
    function AddSectionComponent(sectionervice, router, activeRouter) {
    ...
    AddSectionComponent.prototype.submit = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.sectionervice.addSection(_this.newsection).subscribe(function (data) {
...
var EditSectionComponent = /** @class */ (function () {
    function EditSectionComponent(sectionervice, router, activeRouter) {
        this.sectionervice = sectionervice;
        this.router = router;
        this.activeRouter = activeRouter;
        this.updatedSection = {};
    ...
    EditSectionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sectionervice.getsectionById(this.sectionid).subscribe(function (data) {
            console.log("sectionlist>>", data);
            _this.updatedSection = data.data;
        }, function (error) {
            console.log("cant fetch");
        });
    };
    EditSectionComponent.prototype.update = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.sectionervice.editsection(_this.updatedSection).subscribe(function (data) {
    ...
    EditSectionComponent.ctorParameters = function () { return [
        { type: _services_section_service__WEBPACK_IMPORTED_MODULE_2__["SectionService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
    ]; };
...
var SectionComponent = /** @class */ (function () {
    function SectionComponent(sectionservice, router) {
    ...
    SectionComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sectionservice.getSection().subscribe(function (data) {
            console.log("sectionlist>>", data);
    ...
    SectionComponent.prototype.edit = function (id) {
        console.log("section id>>", id);
        this.router.navigate(["section/edit/" + id]);
    };
    SectionComponent.prototype.delete = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            .fire({
            ...
            if (result.value) {
                //dev
                _this.sectionservice.deleteSection(id).subscribe(function (data) {
...
var SectionService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SectionService, _super);
    function SectionService(http) {
        var _this = _super.call(this, "section") || this;
        _this.http = http;
        return _this;
    }
    SectionService.prototype.addSection = function (data) {
    ...
    SectionService.prototype.getsectionById = function (id) {
        return this.http.get(this.url + id, this.getOptions());
    };
    SectionService.prototype.editsection = function (data) {
