...
let AddIncomeComponent = class AddIncomeComponent {
    constructor(incomeservice, router, activeRouter, activeModal) {
    ...
    ngOnInit() {
        this.incomeservice.getApplicants().subscribe((data) => {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a
            ...
            if (result.value) {
                ...
                this.incomeservice.addIncome(this.newincome).subscribe((data) => {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire("Add!", "Applicant has been added.", "success").then(() => {
                        this.router.navigate(['account/income']);
                    });
                    //dev
...
AddIncomeComponent.ctorParameters = () => [
...
let FeeComponent = class FeeComponent {
    constructor(router, activeRouter) {
        this.router = router;
        this.activeRouter = activeRouter;
        this.feeservice = [
            {
...
let IncomeRoutingModule = class IncomeRoutingModule {
};
...
let IncomeComponent = class IncomeComponent {
    constructor(modalService, activeModal, router, activeRouter) {
    ...
    makepayment() {
        const modalRef = this.modalService.open(_payment_payment_component__WEBPACK_IMPORTED_MODULE_3__["PaymentComponent"], {
...
let PaymentComponent = class PaymentComponent {
    constructor(activeModal, router, activeRouter) {
        this.activeModal = activeModal;
        this.router = router;
        this.activeRouter = activeRouter;
        this.newpayment = {};
...
let IncomeService = class IncomeService extends app_shared_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super("");
        this.http = http;
    }
