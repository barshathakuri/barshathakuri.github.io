...
var AddBatchComponent = /** @class */ (function () {
    function AddBatchComponent(batchservice, router, activeRouter) {
    ...
    AddBatchComponent.prototype.submit = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.batchservice.addBatch(_this.newbatch).subscribe(function (data) {
    ...
    AddBatchComponent.ctorParameters = function () { return [
...
var BatchComponent = /** @class */ (function () {
    function BatchComponent(batchservice, router) {
        this.batchservice = batchservice;
        this.router = router;
        this.batchList = [];
    }
    BatchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.batchservice.getBatch().subscribe(function (data) {
            console.log("batchlist>>", data);
            _this.batchList = data.data;
        }, function (error) {
            console.log("cant fetch");
        });
    };
    BatchComponent.prototype.edit = function (id) {
        console.log("batch id>>", id);
        this.router.navigate(["/visa/batch/edit/" + id]);
    };
    BatchComponent.prototype.delete = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            .fire({
            ...
            if (result.value) {
                //dev
                _this.batchservice.deleteBatch(id).subscribe(function (data) {
    ...
    BatchComponent.ctorParameters = function () { return [
...
var EditbatchComponent = /** @class */ (function () {
    function EditbatchComponent(batchservice, router, activeRouter) {
        this.batchservice = batchservice;
        this.router = router;
        this.activeRouter = activeRouter;
        this.updatedbatch = {};
    ...
    EditbatchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.batchservice.getbatchById(this.batchid).subscribe(function (data) {
            console.log("batchlist>>", data);
            _this.updatedbatch = data.data;
        }, function (error) {
            console.log("cant fetch");
        });
    };
    EditbatchComponent.prototype.update = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.batchservice.editbatch(_this.updatedbatch).subscribe(function (data) {
    ...
    EditbatchComponent.ctorParameters = function () { return [
        { type: _services_batch_service__WEBPACK_IMPORTED_MODULE_2__["BatchService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
    ]; };
...
var BatchService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](BatchService, _super);
    function BatchService(http) {
        var _this = _super.call(this, "batch") || this;
        _this.http = http;
        return _this;
    }
    BatchService.prototype.addBatch = function (data) {
    ...
    BatchService.prototype.editbatch = function (data) {
