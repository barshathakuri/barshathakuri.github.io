...
var AddExpensesComponent = /** @class */ (function () {
    function AddExpensesComponent(expensesservice, router, activeRouter) {
    ...
    AddExpensesComponent.prototype.ngOnInit = function () {
        var _this = this;
        var i;
        this.expensesservice.getCategory().subscribe(function (data) {
            console.log("categorydata--->", data);
            for (i = 0; i < data.data.length; i++) {
                _this.categoryNameList.push(data.data[i].categoryname);
            }
            console.log('NAMESSSS IN LIST ', _this.categoryNameList);
        }, function (err) {
            console.log(err);
        });
    };
    AddExpensesComponent.prototype.submit = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.expensesservice.addExpenses(_this.newexpenses).subscribe(function (data) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire("Add!", "Expenses has been added.", "success").then(function () {
                        _this.router.navigate(['account/manage/expenses']);
                    });
                    //dev
    ...
    AddExpensesComponent.ctorParameters = function () { return [
...
var EditExpensesComponent = /** @class */ (function () {
    function EditExpensesComponent(expensesservice, router, activeRouter) {
        this.expensesservice = expensesservice;
        this.router = router;
        this.activeRouter = activeRouter;
        this.categoryNameList = [];
    ...
    EditExpensesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.expensesservice.getExpensesById(this.expensesid).subscribe(function (data) {
            console.log("expenseslist>>", data);
            _this.updatedExpenses = data.data;
        }, function (error) {
    ...
    EditExpensesComponent.prototype.update = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.expensesservice.editExpenses(_this.updatedExpenses).subscribe(function (data) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire("Edit!", "Expenses has been edited.", "success").then(function () {
                        _this.router.navigate(['account/manage/expenses']);
                    });
                    //dev
                    console.log("Dataaa changeddd", data);
    ...
    EditExpensesComponent.ctorParameters = function () { return [
        { type: _services_expenses_service__WEBPACK_IMPORTED_MODULE_2__["ExpensesService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
    ]; };
...
var ExpensesComponent = /** @class */ (function () {
    function ExpensesComponent(expensesservice, router) {
        this.expensesservice = expensesservice;
        this.router = router;
        this.expensesList = [];
    }
    ExpensesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.expensesservice.getExpenses().subscribe(function (data) {
            console.log("expenseslist>>", data);
    ...
    ExpensesComponent.prototype.edit = function (id) {
        console.log("expenses id>>", id);
        this.router.navigate(["account/manage/expenses/edit/" + id]);
    };
    ExpensesComponent.prototype.delete = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            .fire({
            ...
            if (result.value) {
                //dev
                _this.expensesservice.deleteExpenses(id).subscribe(function (data) {
...
var Expenses = /** @class */ (function () {
    function Expenses(expensesInfo) {
        this.category = expensesInfo.category || "";
        this.amount = expensesInfo.amount || "";
    }
    Expenses.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return Expenses;
}());
