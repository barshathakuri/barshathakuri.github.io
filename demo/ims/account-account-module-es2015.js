...
const routes = [
    ...
    {
        path: "income",
        loadChildren: () => Promise.all(/*! import() | income-income-module */[__webpack_require__.e("default~batch-batch-module~category-category-module~course-course-module~email-email-module~enquirie~b615e052"), __webpack_require__.e("income-income-module")]).then(__webpack_require__.bind(null, /*! ./income/income.module */ "./src/app/account/income/income.module.ts")).then(m => m.IncomeModule)
    },
    {
        path: "manage",
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./manage/manage.module */ "./src/app/account/manage/manage.module.ts")).then(m => m.ManageModule)
    }
];
