...
let AddUserComponent = class AddUserComponent {
    constructor(usersservice, router, activeRouter) {
...
let UsersService = class UsersService extends _shared_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super("users");
        this.http = http;
    }
...
let UsersComponent = class UsersComponent {
    constructor(usersservice, router, config) {
        this.usersservice = usersservice;
        this.router = router;
        this.page = 4;
        this.page1 = 4;
