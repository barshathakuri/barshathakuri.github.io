...
var AddSourceComponent = /** @class */ (function () {
    function AddSourceComponent(sourceservice, router, activeRouter) {
        this.sourceservice = sourceservice;
        this.router = router;
        this.activeRouter = activeRouter;
        this.newsource = new app_shared_models_source_model__WEBPACK_IMPORTED_MODULE_5__["Source"]({});
    }
    AddSourceComponent.prototype.ngOnInit = function () { };
    AddSourceComponent.prototype.submit = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.sourceservice.addSource(_this.newsource).subscribe(function (data) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
                        .fire("Add!", "Source has been added.", "success")
                        .then(function () {
                        _this.router.navigate(["account/source"]);
                    });
                    //dev
    ...
    AddSourceComponent.ctorParameters = function () { return [
...
var EditSourceComponent = /** @class */ (function () {
    function EditSourceComponent(sourceservice, router, activeRouter) {
        this.sourceservice = sourceservice;
        this.router = router;
        this.activeRouter = activeRouter;
    ...
    EditSourceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sourceservice.getSourceById(this.sourceid).subscribe(function (data) {
            console.log("sourcelist>>", data);
            _this.updatedsource = data.data;
        }, function (error) {
            console.log("cant fetch");
        });
    };
    EditSourceComponent.prototype.update = function () {
        var _this = this;
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                _this.sourceservice.editSource(_this.updatedsource).subscribe(function (data) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
    ...
    EditSourceComponent.ctorParameters = function () { return [
        { type: _services_source_service__WEBPACK_IMPORTED_MODULE_2__["SourceService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
    ]; };
...
var SourceService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SourceService, _super);
    function SourceService(http) {
        var _this = _super.call(this, "source") || this;
        _this.http = http;
        return _this;
    }
    SourceService.prototype.getSource = function () {
    ...
    SourceService.prototype.editSource = function (data) {
        return this.http.put(this.url + data._id, { data: data }, this.getOptions());
    };
    SourceService.prototype.deleteSource = function (id) {
        return this.http.delete(this.url + id);
    };
    SourceService.prototype.addSource = function (data) {
...
var SourceRoutingModule = /** @class */ (function () {
    function SourceRoutingModule() {
    }
...
var SourceComponent = /** @class */ (function () {
    function SourceComponent(sourceservice, router) {
        this.sourceservice = sourceservice;
        this.router = router;
        this.sourceList = [];
    }
    SourceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.sourceservice.getSource().subscribe(function (data) {
            console.log("sourcelist>>", data);
    ...
    SourceComponent.prototype.edit = function (id) {
        console.log("source id>>", id);
        this.router.navigate(["account/manage/source/edit/" + id]);
    };
    SourceComponent.prototype.delete = function (id) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            .fire({
            ...
            if (result.value) {
                //dev
                _this.sourceservice.deleteSource(id).subscribe(function (data) {
...
//# sourceMappingURL=source-source-module-es5.js.map