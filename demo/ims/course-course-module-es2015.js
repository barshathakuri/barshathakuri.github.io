...
let AddCourseComponent = class AddCourseComponent {
    constructor(courseervice, router, activeRouter) {
    ...
    submit() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                this.courseervice.addCourse(this.newcourse).subscribe((data) => {
...
let EditCourseComponent = class EditCourseComponent {
    ...
    ngOnInit() {
        this.courseervice.getcourseById(this.courseid).subscribe((data) => {
            console.log("courselist>>", data);
            this.updatedCourse = data.data;
        }, error => {
            console.log("cant fetch");
        });
    }
    update() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                //dev
                this.courseervice.editcourse(this.updatedCourse).subscribe((data) => {
...
let CourseService = class CourseService extends app_shared_services_base_service__WEBPACK_IMPORTED_MODULE_3__["BaseService"] {
    constructor(http) {
        super("course");
        this.http = http;
    }
