...
let AddTeacherComponent = class AddTeacherComponent {
    ...
    submit() {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a
            ...
            if (result.value) {
                //dev
                this.teachersservice.addTeacher(this.newteacher).subscribe((data) => {
...
let EditTeacherComponent = class EditTeacherComponent {
    constructor(teacherservice, router, activeRouter) {
    ...
    edit() {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a
            ...
            if (result.value) {
                this.teacherservice
                    .editTeacher(this.updatedTeacher, this.teacherid)
                    .subscribe((data) => {
...
let TeacherService = class TeacherService extends _shared_services_base_service__WEBPACK_IMPORTED_MODULE_2__["BaseService"] {
    constructor(http) {
        super("teacher");
        this.http = http;
    }
